  ...
  return (
    <div style={{ position: "relative", minHeight: "100vh", overflow: "hidden", color: INK, fontFamily: SYS_FONT }}>
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 1100, margin: "0 auto", padding: "72px 32px 48px" }}>
        <div style={{ fontSize: 32, fontWeight: 600, letterSpacing: "-0.02em" }}>Loka Blog Cover Builder</div>
        <div style={{ color: INK_SOFT, fontSize: 15, marginTop: 8 }}>Pick a template to start</div>

        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(340px, 1fr))", gap: 28, marginTop: 44 }}>
          {TEMPLATES.map((tpl) => {
